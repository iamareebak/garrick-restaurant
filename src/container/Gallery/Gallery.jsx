  ...
  <div className="app__gallery app__bg flex__center">
    ...
    <div className="app__gallery-images">
        ...
        <div className="app__gallery-images-container" ref={scrollRef}>
          {/* This container is for images */}

          {galleryImages.map((image, index) => (
            <div className="app__gallery-images-card flex__center" key={`gallery-image-${index+1}`}>
              {/* Notice how ` ` is used not ' '  String interpolation is used.*/}
        ...
        <div className="app__gallery-images-arrows">
          {/* This container is for buttons for left and right*/}
